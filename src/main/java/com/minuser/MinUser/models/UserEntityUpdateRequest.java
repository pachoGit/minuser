...
{
    @Positive(message = "The field id is a number required")
    private Long id;
    ...
    public UserEntityUpdateRequest() {}

    public UserEntityUpdateRequest(Long id, String name, String lastname, String document, String phone, String email, Long idJob)
    {
        this.id = id;
        this.name = name;
